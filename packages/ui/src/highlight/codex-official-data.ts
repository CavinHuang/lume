// 完整代码高亮主题数据（light/dark 双变体）：245 条语言级 TextMate 规则 + 16 语义 token + 编辑器色。
// 仅数据，无行为；命名包装见 ./codex-themes.ts。禁止手工编辑个别色值——需整体重新生成。
import type { ThemeRegistration } from 'shiki'

export const CODEX_OFFICIAL_LIGHT_DATA: ThemeRegistration = {
  name: 'Codex Light',
  type: 'light',
  colors: {
...
export const CODEX_OFFICIAL_DARK_DATA: ThemeRegistration = {
  name: 'Codex Dark',
  type: 'dark',
  colors: {

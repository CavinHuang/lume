...
describe("WebFetch special handlers", () => {
  test("registers the built-in site categories", () => {
    expect(specialHandlerNames.length).toBe(72);
  ...
  test("all registered site handlers have a runnable migration path", async () => {
    const cases: Array<[string, string]> = [
      ...
      ["youtube", "https://youtube.com/watch?v=abcdefghijk"], ["vimeo", "https://vimeo.com/123"], ["spotify", "https://open.spotify.com/track/abc"], ["discogs", "https://discogs.com/release/1"], ["musicbrainz", "https://musicbrainz.org/artist/abc"],
      ...
      ["huggingface", "https://huggingface.co/models/org/demo"], ["ollama", "https://ollama.com/library/demo"], ["arxiv", "https://arxiv.org/abs/1234.5678"], ["biorxiv", "https://www.biorxiv.org/content/10.1"], ["crossref", "https://doi.org/10.1234/demo"], ["iacr", "https://eprint.iacr.org/1234"], ["orcid", "https://orcid.org/0000-0000-0000-0000"], ["semantic-scholar", "https://www.semanticscholar.org/paper/abc"], ["pubmed", "https://pubmed.ncbi.nlm.nih.gov/123"], ["rfc", "https://www.rfc-editor.org/rfc/rfc1"], ["cisa-kev", "https://www.cisa.gov/known-exploited-vulnerabilities-catalog?CVE-2024-1234"], ["nvd", "https://nvd.nist.gov/vuln/detail/CVE-2024-1234"], ["osv", "https://osv.dev/vulnerability/CVE-2024-1234"], ["coingecko", "https://www.coingecko.com/en/coins/bitcoin"], ["sec-edgar", "https://www.sec.gov/Archives/edgar/data/1234"], ["openlibrary", "https://openlibrary.org/works/OL1W"], ["choosealicense", "https://choosealicense.com/licenses/mit"], ["w3c", "https://www.w3.org/specifications/demo"], ["spdx", "https://spdx.dev/licenses/MIT"], ["wikidata", "https://www.wikidata.org/wiki/Q42"], ["wikipedia", "https://en.wikipedia.org/wiki/Test"],
    ];

...
import { buildResult, formatMediaDuration, loadPage } from "./types.js";
...
export async function fetchGitHubApi(
	...
	try {
		...
		const response = await getRuntimeFetch()(`https://api.github.com${endpoint}`, {

...
export const composerControlMenuClassName =
  'absolute bottom-full left-0 z-50 mb-2 rounded-xl border border-[color:color-mix(in_oklab,var(--border-strong)_58%,transparent)] bg-[var(--surface-1)] shadow-[0_18px_42px_-28px_hsl(var(--shadow-panel)/0.42)]'

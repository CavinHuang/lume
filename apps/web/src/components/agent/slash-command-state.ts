...
export type MentionItemType = 'file' | 'skill' | 'mcp' | 'command' | 'agent' | 'plugin' | 'browser'
export type MentionSection = 'capability' | 'skill' | 'agent' | 'browser-tab' | 'chrome-page' | 'file' | 'project-file' | 'session-file' | 'plugin'

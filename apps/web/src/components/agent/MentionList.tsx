...
import { Blocks, Bot, File, Globe2, Hash, TerminalSquare, ArrowLeft, Loader2, Package, BookOpen } from 'lucide-react'
...
export const MentionList = forwardRef<MentionListRef, MentionListProps>(
  function MentionList({ items, command, trigger = '/', getWorkspaceSlug, onCommandExecute, onBrowserReferenceSelect }, ref) {
    ...
    const panelTitle = trigger === '@' ? 'Agents & Context' : trigger === '#' ? 'MCP Servers' : 'Slash Commands'

...
export function LumeSidebar({
  ...
  if (collapsed) {
    ...
    return (
      <aside className="flex h-full w-[72px] -ml-2 flex-col  text-[var(--lume-text-primary)]">
  ...
  return (
    <aside className="flex h-full w-[286px] min-w-[286px] -ml-2 flex-col  text-[var(--lume-text-primary)]">

...
export const TOOL_METADATA: Record<string, FrontendToolMeta> = {
  ...
  office_clean: {
    name: 'office_clean',
    label: 'Office Clean',
    description: '清理 Office 文档中的孤立资源',
    category: 'write',
    riskLevel: 'medium',
  },
  office_convert: {
  ...
  docx_create: {
    name: 'docx_create',
    label: 'DOCX Create',
    description: '使用 JS 代码创建 Word 文档',
    category: 'write',
    riskLevel: 'medium',
  },
  pptx_create: {
  ...
  pptx_add_slide: {
    name: 'pptx_add_slide',
    label: 'PPTX Add Slide',
    description: '向 PPTX 添加幻灯片',
    category: 'write',
    riskLevel: 'medium',
  },
  xlsx_recalc: {
  ...
  info_extract: {
    name: 'info_extract',
    label: 'Info Extract',
    description: '从文档中提取关键信息（合同、简历、报告等）',
    category: 'read',
    riskLevel: 'low',
  },
  office_thumbnail: {
  ...
  weread_reading_profile: {
    name: 'weread_reading_profile',
    label: 'Weread Reading Profile',
    description: '交叉分析微信读书书架、笔记深度和最近活动',
    category: 'network',
    riskLevel: 'low',
  },
  weread_bookmarks: {
  ...
  weread_book_info: {
    ...
    label: 'Weread Book Info',
    description: '读取微信读书书籍详情',
    category: 'network',
    riskLevel: 'low',
  },
  weread_chapters: {
    name: 'weread_chapters',
    label: 'Weread Chapters',
    description: '读取微信读书章节目录',
    category: 'network',
    riskLevel: 'low',
  },
  weread_book_context: {
    name: 'weread_book_context',
    label: 'Weread Book Context',
    description: '读取书籍详情、章节、个人划线和想法',
    category: 'network',
    riskLevel: 'low',
  },
  weread_recommend: {
    name: 'weread_recommend',
    label: 'Weread Recommend',
    description: '读取微信读书个性化推荐',
    category: 'network',
    riskLevel: 'low',
  },
  weread_similar: {
    name: 'weread_similar',
    label: 'Weread Similar',
    description: '读取微信读书相似书推荐',
    category: 'network',
    riskLevel: 'low',
  },
}

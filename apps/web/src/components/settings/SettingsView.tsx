    ...
    <div className="flex h-full w-full min-w-0 gap-8 bg-[var(--background)]">
      <aside className="flex h-full min-h-0 w-[286px] min-w-[286px] shrink-0 flex-col border-r border-sidebar-border bg-[var(--lume-bg-rail)] pl-2 pb-5 pt-3">
        <Button
          ...
          className="mb-2 mr-2 flex h-8 w-full shrink-0 items-center justify-start gap-2 text-[13px] font-medium text-[var(--text-2)]"
        >
                  ...
                  {group.items.map((id) => {
                    ...
                    return (
                      <Button
                        ...
                        onClick={() => setTab(id)}
                        className={cn(
                          'flex h-9 w-full items-center justify-start gap-2.5 text-[13px] font-medium transition-colors',
                          selected
      ...
      <ScrollArea className="flex-1 min-w-0 min-h-0 pt-4 pb-0">

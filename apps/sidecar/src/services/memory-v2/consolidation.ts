...
import { type LumeRuntimeEvent, type MemoryDreamResult, type MemoryOrganizeProgress } from "@lume/shared";
...
function notifyProgress(
  ...
  emitRuntimeEventNotification(context.threadId, event);
}
...
function notifyCompleted(
  ...
  emitRuntimeEventNotification(context.threadId, memoryChangedEvent);

...
export const API_MEMBERS = freezeArrayRecord({
    ...
    CapabilityCollection: ["list", "get"],
    VisibilityCapability: ["documentation", "get", "set"],
    ViewportCapability: ["documentation", "set", "reset"],
    PageAssetsCapability: ["documentation", "list", "bundle"],

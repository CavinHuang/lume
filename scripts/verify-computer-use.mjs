...
const checks = [
  ...
  [bun, ["test", "apps/web/src/components/settings/desktop-assistant-proposals-state.test.ts"]],
  [bun, ["test", "apps/sidecar/src/services/desktop-context/desktop-context-service.test.ts"]],
  [bun, ["test", "apps/sidecar/src/services/desktop-context/desktop-proposal-generator.test.ts"]],
  ["node", ["--experimental-strip-types", "--test", "apps/sidecar/src/services/desktop-context/desktop-context-store.test.mts"]],

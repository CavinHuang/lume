...
- [ ] **Step 1: Add the shared diagnostics shape.**
...
- [ ] **Step 2: Extract the shared status projection.**
...
- [ ] **Step 3: Register and expose the RPC.**
...
- [ ] **Step 1: Define the navigation contract.**
...
- [ ] **Step 3: Bump the version for runtime events.**
...
- [ ] **Step 4: Test navigation normalization.**
...
- [ ] **Step 1: Move fetch state and mutation handlers.**
...
- [ ] **Step 2: Subscribe the controller to the version atom.**
...
- [ ] **Step 3: Preserve revision safety and stale draft behavior.**
...
- [ ] **Step 1: Create the center shell.**
...
- [ ] **Step 2: Implement the attention queue.**
...
- [ ] **Step 3: Implement the memory library.**
...
- [ ] **Step 4: Implement insights and activity.**
...
- [ ] **Step 1: Move configuration panels.**
...
- [ ] **Step 2: Replace full Snapshot status reads.**
...
- [ ] **Step 3: Keep the public export stable.**
...
- [ ] **Step 4: Update settings copy and test.**
...
- [ ] **Step 1: Make the old component a compatibility wrapper.**
...
- [ ] **Step 2: Change visible navigation labels.**
...
- [ ] **Step 3: Remove duplicate memory fetches.**
...
- [ ] **Step 1: Add a typed target to memory system messages.**
...
- [ ] **Step 1: Run focused shared and sidecar checks.**

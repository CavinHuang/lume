...
static CACHE_TTL_MS: LazyLock<u64> = LazyLock::new(|| parse_env_u64("FS_SCAN_CACHE_TTL_MS", 1_000));
static EMPTY_RECHECK_MS: LazyLock<u64> = LazyLock::new(|| parse_env_u64("FS_SCAN_EMPTY_RECHECK_MS", 200));
static MAX_CACHE_ENTRIES: LazyLock<usize> = LazyLock::new(|| parse_env_u64("FS_SCAN_CACHE_MAX_ENTRIES", 16) as usize);
static GREP_WORKERS: LazyLock<usize> = LazyLock::new(|| parse_env_u64("LUME_GREP_WORKERS", 4) as usize);
